// frontend/src/pages/AdminPage.jsx (Perubahan penting)
...
const Admin = () => {
 ...
 const verifyAndLoadAdminData = useCallback(async () => {
  ...
  try {
   ...
   // ⭐ PERBAIKAN PENTING DI SINI: Ganti 5000 menjadi 3001 ⭐
   const statsRes = await axios.get('http://localhost:3001/api/admin/dashboard-stats', config);
  ...
  <div className="admin-page-container">
   ...
   <main className="admin-content">
    ...
    <section className="admin-section user-management-section">
     ...
     <AdminUserTable token={localStorage.getItem('authToken')} />
    </section>
